...
function HEX3DHEX3D__jscore95examples951_u72(x_p0, y_p1) {
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      F.line = 81;
      F.filename = "iterators_1.nim";
      var colontmp__671088901 = 0;
      F.line = 333;
      F.filename = "comparisons.nim";
      colontmp__671088901 = subInt((x_p0).length, 1);
      F.line = 96;
      F.filename = "iterators_1.nim";
      var res_671088902 = 0;
      Label2: {
        F.line = 97;
          Label3: while (true) {
          if (!(res_671088902 <= colontmp__671088901)) break Label3;
            F.line = 333;
            F.filename = "comparisons.nim";
            i_671088738 = res_671088902;
            ...
            F.line = 102;
            F.filename = "iterators_1.nim";
            res_671088902 = addInt(res_671088902, 1);
          }
      };
    };
    F.line = 337;
