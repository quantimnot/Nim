...
function HEX3DHEX3D__jsheaders95examples951_u13(x_p0, y_p1) {
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      F.line = 81;
      F.filename = "iterators_1.nim";
      var colontmp__671088906 = 0;
      F.line = 333;
      F.filename = "comparisons.nim";
      colontmp__671088906 = subInt((x_p0).length, 1);
      F.line = 96;
      F.filename = "iterators_1.nim";
      var res_671088908 = 0;
      Label2: {
        F.line = 97;
          Label3: while (true) {
          if (!(res_671088908 <= colontmp__671088906)) break Label3;
            F.line = 333;
            F.filename = "comparisons.nim";
            i_671088679 = res_671088908;
            ...
            F.line = 102;
            F.filename = "iterators_1.nim";
            res_671088908 = addInt(res_671088908, 1);
          }
      };
    };
    F.line = 337;
...
function HEX3DHEX3D__jsheaders95examples951_u72(x_p0, y_p1) {
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      F.line = 81;
      F.filename = "iterators_1.nim";
      var colontmp__671088911 = 0;
      F.line = 333;
      F.filename = "comparisons.nim";
      colontmp__671088911 = subInt((x_p0).length, 1);
      F.line = 96;
      F.filename = "iterators_1.nim";
      var res_671088912 = 0;
      Label2: {
        F.line = 97;
          Label3: while (true) {
          if (!(res_671088912 <= colontmp__671088911)) break Label3;
            F.line = 333;
            F.filename = "comparisons.nim";
            i_671088738 = res_671088912;
            ...
            F.line = 102;
            F.filename = "iterators_1.nim";
            res_671088912 = addInt(res_671088912, 1);
          }
      };
    };
    F.line = 337;
