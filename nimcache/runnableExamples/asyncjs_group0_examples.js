...
async function fn_822083591(n_822083592) {
  ...
  framePtr = F;
    if ((7 <= n_822083592)) {
    F.line = 236;
    raiseException({message: (makeNimstrLit("foobar: ") || []).concat(cstrToNimstr((n_822083592) + "") || []), parent: null, m_type: NTI33555108, name: null, trace: [], up: null}, "ValueError");
    }
    else {
      F.line = 236;
